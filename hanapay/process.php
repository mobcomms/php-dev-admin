...
if(
	REFER($_POST['refpage'], '/hanapay/board_brand_write.php') != true &&
	REFER($_POST['refpage'], '/hanapay/board_brand_util_write.php') != true &&
	REFER($_POST['refpage'], '/hanapay/board_banner_write.php') != true &&
	REFER($_POST['refpage'], '/hanapay/board_promotion_write.php') != true &&
	REFER($_POST['refpage'], '/hanapay/board_noti_write.php') != true &&
	REFER($_POST['refpage'], '/hanapay/theme_write.php') != true &&
	REFER($_POST['refpage'], '/hanapay/theme.php') != true &&
...
Switch($_POST['refpage']) {
	...
	default:    ## 이외 리다이렉트
		...
		Alert("권한이 없습니다");
		Loca("/hanapay/login.php");
		exit;

	break;

	## 브랜드, 고정광고 ,프로모션 등록, 노티 추가
	Case '/hanapay/board_brand_write.php':
	Case '/hanapay/board_brand_util_write.php':
	Case '/hanapay/board_banner_write.php':
	Case '/hanapay/board_promotion_write.php':
	Case '/hanapay/board_noti_write.php':

		if($_POST['refpage'] =='/hanapay/board_brand_write.php'){
			$go_page = "board_brand_write.php";
			$go_page_l = "board_brand.php";
		}else if($_POST['refpage'] =='/hanapay/board_brand_util_write.php'){
			$go_page = "board_brand_util_write.php";
			$go_page_l = "board_brand_util.php";
		}else if($_POST['refpage'] =='/hanapay/board_banner_write.php'){
			$go_page = "board_banner_write.php";
			$go_page_l = "board_banner.php";
		}else if($_POST['refpage'] =='/hanapay/board_promotion_write.php'){
			$go_page = "board_promotion_write.php";
			$go_page_l = "board_promotion.php";
		}else if($_POST['refpage'] =='/hanapay/board_noti_write.php'){
		...
		if($_POST['refpage'] =='/hanapay/board_noti_write.php'){
			$s_hour = ret(INPUT_POST, 's_hour');
			$s_min = ret(INPUT_POST, 's_min');
			$url = $s_hour.":".$s_min;
		}
	...
	Case '/hanapay/theme_write.php' : ## 테마등록
	...
	Case '/hanapay/theme.php' : ## 테마삭제
		...
		if($mode == 'DEL') {
			...
			exit($fn->loca('/hanapay/theme.php', '삭제되었습니다.'));
		}
