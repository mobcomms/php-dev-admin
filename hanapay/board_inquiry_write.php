...
$sql="
	SELECT cui.os, cbi.type, cbi.question, cbi.answer, cbi.bbs_state, cbi.regdate, cbi.reg_user, cbi.editdate, file_path, file_name
	...
	WHERE del_yn = 'N' AND cbi.seq=:seq
...
$img_link = empty($result['file_path'])?"":"https://hanapay-api.commsad.com/".$result['file_path'].$result['file_name'];
				...
				<div class="row">
					<div class="panel panel-default">
						...
						<div class="form-group">
							...
							<div class="col-sm-9"><?=empty($result['os'])?"없음":$result['os']?></div>
						</div>
...
<script>
	...
	$(document).ready(function(){
		$("input[name=content]").on("click", function(){
			var text = "";
			switch($(this).val()){
				case "1" : text = "안녕하세요. 키보드 보너스적립 운영진입니다.\n" +
					"전달 주신 내용으로는 정확한 문의 내용을 파악하기 어렵습니다.\n" +
					"발생한 오류  내용 전달해주시면,  확인해보도록 하겠습니다.\n" +
					"감사합니다.";
				break;
				case "2" : text = "안녕하세요. 키보드 보너스적립 운영진입니다.\n" +
					"많은 기대로 이용을 해 주셨을 텐데 이용에 불편을 드려 죄송합니다.\n" +
					"말씀해 주신 내용은 유관부서로 전달하였으며, 빠른 시일 내에 처리 될 수 있도록 노력하겠습니다.\n" +
					"감사합니다.";
				break;
				case "3" : text = "안녕하세요. 키보드 보너스적립 운영진입니다.\n" +
					"많은 기대로 이용을 해 주셨을 텐데 이용에 불편을 드려 죄송합니다.\n\n" +
					"첫번째 키보드 변경 방법입니다.\n" +
					"자판 오른쪽에 아래쪽 구석을 보시면  자판모양 아이콘이 있습니다.\n" +
					"이걸 클릭하시면 원래 키보드로 변경 가능합니다.\n\n" +
					"두번째 보너스적립 OFF 처리 방법입니다.\n" +
					"휴대폰 설정 > 기본 키보드 및 추가 키보드설정 > 기본 키보드 > 키보드 보너스적립 설정 해제.\n" +
					"감사합니다.";
				break;
				case "4" : text = "안녕하세요. 키보드 보너스적립 운영진입니다.\n" +
					"많은 기대로 이용을 해 주셨을 텐데 이용에 불편을 드려 죄송합니다.\n\n" +
					"(주의) ※ 보너스적립 앱이 로그인이 해제됩니다.\n" +
					"휴대폰 설정 > 어플리케이션 > \"보너스적립\" 검색후 클릭 > 저장공간 > 데이터삭제\n\n" +
					"하신후에 천지인(기본) 을 다시 변경 해보시기 바랍니다.\n" +
					"감사합니다." ;
				break;
				case "5" : text = "안녕하세요. 키보드 보너스적립 운영진입니다.\n" +
					"보너스적립 키보드에서는 회원분들에게 다양한 적립 혜택을 드리기 위해 광고가 노출되고 있으며,\n" +
