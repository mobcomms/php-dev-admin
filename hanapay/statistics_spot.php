...
$sql="
	...
	FROM ckd_day_app_stats ODS
	LEFT JOIN ckd_save_point_one_day OUP ON OUP.stats_dttm = ODS.stats_dttm
...
if(!empty($ret)) {
	...
	$html='<tr><td colspan="13">데이터가 없습니다.</td></tr>';
}
