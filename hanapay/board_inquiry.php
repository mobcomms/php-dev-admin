...
if(!empty($_SESSION) && $_SESSION['Adm']['id'] != "mango"){
	exit("권한이 없습니다.");
}
...
$sql="
	...
	LEFT JOIN user AS cui ON  cbi.reg_user = cui.user_key
	WHERE del_yn = 'N' 
	{$subQry}
";
//pre($sql);
...
$sql="
	SELECT cbi.*,cui.adid FROM ckd_bbs_inquiry cbi
	LEFT JOIN user AS cui ON  cbi.reg_user = cui.user_key
	WHERE del_yn = 'N'
	{$subQry}
	ORDER BY cbi.seq DESC
					...
					<div class="col-xs-12 col-md-12">
						...
						<form name="scform" method="get" action="">
							...
							<div class="pull-left" style="margin-bottom: 10px;width: 100%;">
								...
								<label style="margin: 4px 0 0 20px">
									<div class="pull-left"><input style="width:20px;height:20px;accent-color: darkcyan;" type="radio" name="os_type" id="os_type_n" onclick="display_toggle('N');" <?=($os_type=="N")?"checked":""?> value="I"></div>
						...
						<div class="table-responsive">
							<table class="table table-hover mb30 member_table" id="Excel">
								...
								<tr>
                                    ...
                                    <th class="col-md-1">uuid</th>
                                    <th class="col-md-1">adid</th>
...
<script>
	...
	function centerOpenWindow(theURL, winName, width, height, fstate, scrollbars) {
		...
		let win = window.open(theURL,winName,state);
		win.focus();
	}
