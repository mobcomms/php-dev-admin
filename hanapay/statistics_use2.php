...
$tp_code_mobi_aos1 = "999";
$tp_code_mobi_aos2 = "999";
$tp_code_mobi_aos3 = "999";
$tp_code_mobi_ios1 = "999";
$tp_code_mobi_ios2 = "999";
$tp_code_mobi_ios3 = "999";
$tp_code_coupang_aos = "999";
$tp_code_coupang_ios = "999";
$tp_code_pomission = "999";

//일반광고
if(!empty($ad_type[1])){
	$tp_code_mobi_aos1 = "11";
	$tp_code_mobi_aos2 = "12";
	$tp_code_mobi_aos3 = "13";
	$tp_code_mobi_ios1 = "14";
	$tp_code_mobi_ios2 = "15";
	$tp_code_mobi_ios3 = "16";
}
//쿠팡광고
if(!empty($ad_type[2])){
	$tp_code_coupang_aos = "03";
	$tp_code_coupang_ios = "04";
}
//오퍼월
if(!empty($ad_type[3])){
	$tp_code_pomission = "07";
}
//전체
if(empty($ad_type)){
	$tp_code_mobi_aos1 = "11";
...
foreach($ret as $key => $row){
	...
	$total_sales = $row['mw_exhs11']+$row['mw_exhs12']+$row['mw_exhs13']+$row['mw_exhs14']+$row['mw_exhs15']+$row['mw_exhs16']+$row['coupang_order11']+$row['coupang_order12']+$row['offerwall_exhs_amt'];
	$total_settlement = $row['mw_exhs1']+$row['mw_exhs2']+$row['mw_exhs3']+$row['mw_exhs4']+$row['mw_exhs5']+$row['mw_exhs6']+$coupang_income1+$coupang_income2+($row['offerwall_exhs_amt']*0.7);
...
$total_settlement_all = $TOTAL['mw_exhs1']+$TOTAL['mw_exhs2']+$TOTAL['mw_exhs3']+$TOTAL['mw_exhs4']+$TOTAL['mw_exhs5']+$TOTAL['mw_exhs6']+$TOTAL['coupang_income1']+$TOTAL['coupang_income2']+($TOTAL['offerwall_exhs_amt']*0.7);
...
<!--							<td style="color:blue;font-weight:700;">--><?//=number_format($total_sales_all)?><!--</td>-->
					...
					if($type=="3M" || $type=="6M"){
						foreach ($M_TOTAL as $key=>$row){
							...
							$month_total_settlement = $row['mw_exhs1']+$row['mw_exhs2']+$row['mw_exhs3']+$row['mw_exhs4']+$row['mw_exhs5']+$row['mw_exhs6']+$row['coupang_income1']+$row['coupang_income2']+($row['offerwall_exhs_amt']*0.7);
