...
$sql="
	SELECT cui.user_app_os, cbi.type, cbi.question, cbi.answer, cbi.bbs_state, cbi.regdate, cbi.reg_user, cbi.editdate 
					...
					<div class="panel panel-default">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<?=$result['reg_user']?>
								<?php if($user_cnt > 1){ ?>
									<a href="board_inquiry.php?search_type=02&keyword=<?=explode("@",$result['reg_user'])[0]?>" class="btn btn-warning" onClick="">질문 <?=$user_cnt?>건 모아보기</a>
								<?php } ?>
							</div>
						</div>
