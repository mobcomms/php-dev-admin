...
if($idx){
	...
	if($bbs) {
		...
		$sql = "
			...
			WHERE service_tp_code='03' AND type='banner' AND board_idx = '{$idx}'
		";
...
$url="http://".__host__;
$thumb_banner_img=!empty($img_info['banner_img']['file_name']) ? $url."/".$img_info['banner_img']['file_name'] : $url."/img/noImg.jpg";
				...
				<div class="row">
					<div class="panel panel-default">
						...
						<div class="form-group">
							<label class="col-sm-1 control-label" style="width: 200px;" ><span class="asterisk">*</span> 광고 노출 타이틀 </label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<span style="float:left;width:120px;height:100px;display: inline-block;"><img src="<?=$thumb_banner_img?>?<?=time()?>" border="1" style="width:120px;"></span>
								<div class="fileupload fileupload-new" data-provides="fileupload"><input type="hidden">
									<div class="input-append">
										...
										<span class="fileupload-exists">Change</span>
											<input type="file" name="banner_img" onchange="checkFile(this)" accept="image/*">
										</span>
										<a href="#" class="btn btn-default fileupload-exists" data-dismiss="fileupload">Remove</a>
										<?php if(!empty($img_info) && file_exists($img_info['banner_img']['root_path']) === true) { ?>
											<button type="button" class="btn btn-default" onclick="download_theme('<?=$img_info['banner_img']['idx']?>')">다운로드</button>
										<?php } ?>
									</div>
								</div>
							</div>
						...
						<div class="form-group">
							<label class=" col-sm-1 control-label" style="width: 200px;">노출 선택</label>
							<div class="col-sm-9" style="line-height: 38px;">
								<label style="cursor: pointer;"><input type="radio" name="contents" style="width: 20px;" value="Y" <?=empty($bbs['contents']) || $bbs['contents']=="Y"?"checked":""?> />텍스트</label>
								<label style="cursor: pointer;"><input type="radio" name="contents" style="width: 20px;" value="N" <?=!empty($bbs) && $bbs['contents']=="N"?"checked":""?>/>이미지</label>
							</div>
						</div>
				...
				<div class="row">
					<div class="text-center">
						<div class="">
							...
							<?php }?>
							<button type="button" class="btn btn-default" onclick="location.href='board_banner.php' ">목록</button>
						</div>
					</div>
				</div>
			</form>
