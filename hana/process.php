...
if(
	REFER($_POST['refpage'], '/hana/board_brand_write.php') != true &&
	REFER($_POST['refpage'], '/hana/board_brand_util_write.php') != true &&
	REFER($_POST['refpage'], '/hana/board_banner_write.php') != true &&
	REFER($_POST['refpage'], '/hana/board_promotion_write.php') != true &&
	REFER($_POST['refpage'], '/hana/board_noti_write.php') != true &&
	REFER($_POST['refpage'], '/hana/theme_write.php') != true &&
	REFER($_POST['refpage'], '/hana/theme.php') != true &&
...
Switch($_POST['refpage']) {
	...
	Case '/hana/board_brand_write.php':
	Case '/hana/board_brand_util_write.php':
	Case '/hana/board_banner_write.php':
	Case '/hana/board_promotion_write.php':
	Case '/hana/board_noti_write.php':

		if($_POST['refpage'] =='/hana/board_brand_write.php'){
			$go_page = "board_brand_write.php";
			$go_page_l = "board_brand.php";
		}else if($_POST['refpage'] =='/hana/board_brand_util_write.php'){
			$go_page = "board_brand_util_write.php";
			$go_page_l = "board_brand_util.php";
		}else if($_POST['refpage'] =='/hana/board_banner_write.php'){
			$go_page = "board_banner_write.php";
			$go_page_l = "board_banner.php";
		}else if($_POST['refpage'] =='/hana/board_promotion_write.php'){
			$go_page = "board_promotion_write.php";
			$go_page_l = "board_promotion.php";
		}else if($_POST['refpage'] =='/hana/board_noti_write.php'){
		...
		if($_POST['refpage'] =='/hana/board_noti_write.php'){
			$s_hour = ret(INPUT_POST, 's_hour');
			$s_min = ret(INPUT_POST, 's_min');
			$url = $s_hour.":".$s_min;
		}
	...
	Case '/hana/theme_write.php' : ## 테마등록
	...
	Case '/hana/theme.php' : ## 테마삭제
		...
		if($mode == 'DEL') {
			...
			exit($fn->loca('/hana/theme.php', '삭제되었습니다.'));
		}
