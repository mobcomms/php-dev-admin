...
<div class="leftpanel">
	...
	<div class="logopanel">
		<h1>HANA-Keyboard : <font color="#1caf9a" size="3"> <?=strtoupper($admin['level'])?></font></h1>
	</div><!-- logopanel -->
		...
		<ul class="nav nav-pills nav-stacked nav-bracket">
			...
			<li class="nav-parent <?=_Menu_=='manage'?'active nav-active':''?>"><a href="member_info.php"><i class="fa fa-bar-chart-o"></i> <span>통계</span></a>
				<ul class="children" style="display:<?=_Menu_=='manage'?'block':'none'?>;">
					...
					<li class=" <?=_subMenu_=='info'?'active':''?>"><a href="member_list.php"><i class="fa fa-caret-right"></i>키보드 사용자 통계</a></li>
					<li class=" <?=_subMenu_=='game'?'active':''?>"><a href="statistics_game.php"><i class="fa fa-caret-right"></i>사다리 사용 통계</a></li>
                    <?php if($admin['id'] == 'mango'){ ?>
                    <li class="<?=_subMenu_=='fail_status'?'active':''?>"><a href="statistics_fail_status.php"><i class="fa fa-caret-right"></i> <span>(관리자용)광고 호출실패 통계</span></a></li>
					<li class="<?=_subMenu_=='fail'?'active':''?>"><a href="statistics_fail.php"><i class="fa fa-caret-right"></i> <span>(관리자용)광고실패 조회</span></a></li>
   					<li class="<?=_subMenu_=='limit'?'active':''?>"><a href="unique_user.php"><i class="fa fa-caret-right"></i> <span>(관리자용)유니크 유저수 조회</span></a></li>
                    <?php } ?>
			...
			<li class="nav-parent <?=_Menu_=='inquiry'?'active nav-active':''?>"><a href="layouts.html"><i class=" glyphicon glyphicon-picture"></i> <span>문의하기</span></a>
				<ul class="children" style="display:<?=_Menu_=='inquiry'?'block':'none'?>;">
					<li class=" <?=_subMenu_=='inquiry'?'active':''?>"><a href="board_inquiry.php"><i class="fa fa-caret-right"></i>키보드 문의하기</a></li>
