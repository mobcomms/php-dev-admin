		...
		$("input[name=content]").on("click", function(){
			...
			switch($(this).val()){
				...
				case "4" : text = "안녕하세요. 키보드 머니쌓기 운영진입니다.\n" +
					...
					"감사합니다." ;
				break;
				case "5" : text = "안녕하세요. 키보드 머니쌓기 운영진입니다.\n" +
					"머니쌓기 키보드에서는 회원분들에게 다양한 적립 혜택을 드리기 위해 광고가 노출되고 있으며,\n" +
