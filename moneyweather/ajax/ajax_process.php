...
Switch($mode) {
	...
	Case 'set_banner': ## 광고 설정
		...
		if(!empty($file)){
			...
			$ret = $NDO->sql_query($sql,array(":useYN"=>$_REQUEST['useYN'],":img"=>"https://moneyweather-api.commsad.com/img/banner/".$file,":font_color"=>$_REQUEST['font_color'],":unit"=>$_REQUEST['reward_unit'],":point"=>$_REQUEST['reward_point'],":max_point"=>$_REQUEST['reward_max_point'],":frequency"=>$_REQUEST['reward_frequency']));
		}else{
