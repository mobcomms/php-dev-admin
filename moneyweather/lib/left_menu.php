...
<div class="leftpanel">
	...
	<div class="logopanel">
		<h1>moneyweather : <font color="#1caf9a" size="3"> <?=strtoupper($admin['level'])?></font></h1>
	</div><!-- logopanel -->
...
<!--					<li class=" --><?//=_subMenu_=='inquiry_game'?'active':''?><!--"><a href="board_inquiry.php?target=game"><i class="fa fa-caret-right"></i>미션존 문의</a></li>-->
			...
			<li class="nav-parent <?=_Menu_=='gamezone'?'active nav-active':''?>"><a href="member_info.php"><i class="fa fa-cog"></i> <span>미션존 설정</span></a>
				<ul class="children" style="display:<?=_Menu_=='gamezone'?'block':'none'?>;">
					...
					<li class=" <?=_subMenu_=='set_ticket'?'active':''?>"><a href="set_ticket.php"><i class="fa fa-caret-right"></i>복권 설정</a></li>
				</ul>
			</li>
