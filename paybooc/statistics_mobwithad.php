...
//전체 누적 설정수
$sql="
	SELECT stats_dttm,activity_num FROM ckd_day_stats
...
$sql="
	...
	LEFT JOIN ckd_day_coupang_stats CSTATS4 ON CSTATS4.stats_dttm = CDMS.stats_dttm AND CSTATS4.service_tp_code='06'
