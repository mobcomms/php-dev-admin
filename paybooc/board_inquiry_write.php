...
$sql="
	SELECT cui.user_app_os, cbi.type, cbi.question, cbi.answer, cbi.bbs_state, cbi.regdate, cbi.reg_user, cbi.editdate, file_path, file_name, user_adid
...
$img_link = empty($result['file_path'])?"":"https://paybooc-api.commsad.com/".$result['file_path'].$result['file_name'];
