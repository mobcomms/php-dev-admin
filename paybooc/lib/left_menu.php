...
<div class="leftpanel">
	...
	<div class="logopanel">
		<h1>paybooc-SDK : <font color="#1caf9a" size="3"> <?=strtoupper($admin['level'])?></font></h1>
	</div><!-- logopanel -->
	...
	<div class="leftpanelinner">
		...
		<ul class="nav nav-pills nav-stacked nav-bracket">
			...
			<li class="nav-parent <?=_Menu_=='manage'?'active nav-active':''?>"><a href="member_info.php"><i class="fa fa-krw"></i> <span>매출 통계</span></a>
				<ul class="children" style="display:<?=_Menu_=='manage'?'block':'none'?>;">
					<li class=" <?=_subMenu_=='use1'?'active':''?>"><a href="statistics_use.php"><i class="fa fa-caret-right"></i>집계방식1</a></li>
					<li class=" <?=_subMenu_=='use2'?'active':''?>"><a href="statistics_use2.php"><i class="fa fa-caret-right"></i>집계방식2</a></li>
				</ul>
			</li>
			<?php if($_SESSION['Adm']['id'] == "mango"){ ?>
			<li class="<?=_Menu_=='adjustment'?'active':''?>"><a href="statistics_adjustment.php"><i class="fa fa-wpforms"></i> <span>정산</span></a></li>
			<?php } ?>
			...
			<li class="<?=_Menu_=='user'?'active':''?>"><a href="member_list.php"><i class="glyphicon glyphicon-user"></i> <span>사용자 관리</span></a></li>
                <li class="nav-parent <?=_Menu_=='inquiry'?'active nav-active':''?>"><a href="board_inquiry.php"><i class="fa fa-question-circle"></i> <span>문의관리</span></a>
                    <ul class="children" style="display:<?=_Menu_=='inquiry'?'block':'none'?>;">
                        <li class=" <?=_subMenu_=='inquiry'?'active':''?>"><a href="board_inquiry.php"><i class="fa fa-caret-right"></i>머니박스 문의</a></li>
                        <li class=" <?=_subMenu_=='inquiry_game'?'active':''?>"><a href="board_inquiry.php?target=LADDER"><i class="fa fa-caret-right"></i>사다리 문의</a></li>
                    </ul>
                </li>
			<?php } ?>
