					...
					<table class="table table-hover mb30 member_table" id="" style="border: 1px solid #b0b0b0;">
						...
						<?php foreach($ret AS $row){?>
							<tr>
								...
								<td><a href="member_info_ckd.php?uuid=<?=$row['user_uuid']?>" target="_blank">새탭으로 열기</a></td>
								<td><a href="member_info_ocb.php?uuid=<?=$row['user_uuid']?>" target="_blank">새탭으로 열기</a></td>
