				...
				<div class="col-xs-12 col-md-12">
					...
					<div class="row">
						...
						<div class="pull-right">
							<button class="btn btn-primary" onclick="location.href='board_brand_write.php' " style="width: 100px;height: 40px;">등록</button>
...
<!--									<th class="col-md-1" style="width:50px;"><input type="checkbox" class="checkall"> </th>-->
							...
							<tr>
								...
								<td style="text-align: left;padding-left: 20px;">
									<a href="board_brand_write.php?idx=<?= $res['seq'] ?>&page=<?= $now ?>&key=<?= $key ?>&keyword=<?= $keyword ?>"><?=$res['title'] ?> </a>
								</td>
