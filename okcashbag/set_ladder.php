...
if(!empty($_POST)){
	if($_POST['mode'] == "use_YN"){
		...
		$sql = "
			UPDATE ocb_game_zone_set SET use_YN='{$use_YN}'
		...
		$sql = "
			INSERT INTO ocb_game_zone_set SET {$column}
...
$qry = "SELECT * FROM ocb_game_zone_set WHERE code_id='{$code_id}'";
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			...
			<h4 class="panel-title">
				...
				<button class="btn btn-success save" data-code_id="<?=$result['code_id']?>" style="margin-left:10px;">해당 영역 부분 저장</button>
			</h4>
		...
		<form name="form">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-1" style="line-height:35px;">분</div>
				</div>
