...
if($idx){
	...
	if($bbs) {
		...
		$sql = "
			...
			WHERE service_tp_code='03' AND type='util' AND board_idx = '{$idx}'
		";
				...
				<div class="row">
					<div class="panel panel-default">
						...
						<div class="form-group">
							<label class="col-sm-1 control-label" style="width: 200px;" ><span class="asterisk">*</span> 이름 </label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label class=" col-sm-1 control-label" style="width: 200px;">랜딩 링크</label>
							<div class="col-sm-9">
								<input type="text" name="url" class="form-control" style="width:700px" placeholder="아이콘 클릭시 이동할 페이지를 입력해주세요"  value="<?=empty($bbs)?"":$bbs['url']?>" />
							</div>
						</div>
				...
				<div class="row">
					<div class="text-center">
						<div class="">
							...
							<?php }?>
							<button type="button" class="btn btn-default" onclick="location.href='board_brand_util.php' ">목록</button>
						</div>
					</div>
				</div>
			</form>
