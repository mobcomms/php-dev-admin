...
$qry = "
	SELECT * FROM ocb_spot_point_set OSP
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control pull-left border-input" name="s_give_cnt[<?=$row['code_id']?>]" value="<?=$row['s_give_cnt']?>" style="width:100px; height:35px;" autocomplete="off">
