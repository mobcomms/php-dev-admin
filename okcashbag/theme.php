...
";
//pre($sql);
$total = $NDO->fetch_array($sql,$ocb_param);
...
";
//pre($sql);
$ret = $NDO->fetch_array($sql,$ocb_param);
							...
							<table class="table table-hover mb30 member_table">
								...
								for($i=0;$i<count($ret);$i++){
									...
									<tr>
										...
										<td><?=$res['theme_partner_code']=="01"?"구버전":"오퍼월"?>/<?=$premium?></td>
