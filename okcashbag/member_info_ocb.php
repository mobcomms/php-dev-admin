...
<div class="contentpanel">
	...
	<div class="panel panel-default" style="width:900px">
		<div class="panel-heading">
			...
			<h4 class="panel-title">키보드 사용자 (OCB 적립정보) </h4>
		</div><!-- panel-heading -->
			...
			<div class="row col-xs-12 col-md-12">
				<div class="table-responsive">
					...
					<table class="table table-hover mb30 member_table" id="" style="border: 1px solid #b0b0b0;margin-top:0;">
						...
						<tr>
							<td>앱 버전</td>
							<td><?=$user_info['user_app_version']?></td>
							<td>키보드 사용여부</td>
							<td><?=$user_info['user_keyboard_YN']?></td>
						</tr>
						<tr>
							<td>키보드 테마</td>
							<td><?=$user_info['user_app_theme']?></td>
							<td>키보드 종류</td>
		...
		<div class="panel-body">
			<div class="row col-xs-12 col-md-12">
				<div class="table-responsive">
					<div style="float: left;line-height: 40px;">OCB 적립정보</div>
					<div style="display: inline-block;float: right;">
						<button type="button" class="btn btn-success" style="margin-left:10px;" onclick="centerOpenWindow('save_point_admin.php?uuid=<?=$user_info['user_uuid']?>', 'save_point_admin', '500', '451', '', 'N');">포인트 지급</button>
					</div>
					<table class="table table-hover mb30 member_table" id="" style="border: 1px solid #b0b0b0;margin-top:0;">
						<thead>
						<tr>
