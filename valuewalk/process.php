...
if(
	REFER($_POST['refpage'], '/valuewalk/board_brand_write.php') != true &&
	REFER($_POST['refpage'], '/valuewalk/board_brand_util_write.php') != true &&
	REFER($_POST['refpage'], '/valuewalk/board_banner_write.php') != true &&
	REFER($_POST['refpage'], '/valuewalk/board_promotion_write.php') != true &&
	REFER($_POST['refpage'], '/valuewalk/board_noti_write.php') != true &&
	REFER($_POST['refpage'], '/valuewalk/theme_write.php') != true &&
	REFER($_POST['refpage'], '/valuewalk/theme.php') != true &&
...
Switch($_POST['refpage']) {
	...
	default:    ## 이외 리다이렉트
		...
		Alert("권한이 없습니다");
		Loca("/valuewalk/login.php");
		exit;

	break;

	## 브랜드, 고정광고 ,프로모션 등록, 노티 추가
	Case '/valuewalk/board_brand_write.php':
	Case '/valuewalk/board_brand_util_write.php':
	Case '/valuewalk/board_banner_write.php':
	Case '/valuewalk/board_promotion_write.php':
	Case '/valuewalk/board_noti_write.php':

		if($_POST['refpage'] =='/valuewalk/board_brand_write.php'){
			$go_page = "board_brand_write.php";
			$go_page_l = "board_brand.php";
		}else if($_POST['refpage'] =='/valuewalk/board_brand_util_write.php'){
			$go_page = "board_brand_util_write.php";
			$go_page_l = "board_brand_util.php";
		}else if($_POST['refpage'] =='/valuewalk/board_banner_write.php'){
			$go_page = "board_banner_write.php";
			$go_page_l = "board_banner.php";
		}else if($_POST['refpage'] =='/valuewalk/board_promotion_write.php'){
			$go_page = "board_promotion_write.php";
			$go_page_l = "board_promotion.php";
		}else if($_POST['refpage'] =='/valuewalk/board_noti_write.php'){
		...
		if($_POST['refpage'] =='/valuewalk/board_noti_write.php'){
			$s_hour = ret(INPUT_POST, 's_hour');
			$s_min = ret(INPUT_POST, 's_min');
			$url = $s_hour.":".$s_min;
		}
	...
	Case '/valuewalk/theme_write.php' : ## 테마등록
	...
	Case '/valuewalk/theme.php' : ## 테마삭제
		...
		if($mode == 'DEL') {
			...
			exit($fn->loca('/valuewalk/theme.php', '삭제되었습니다.'));
		}
