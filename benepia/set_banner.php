		...
		<div class="panel-body">
			...
			<div class="table-responsive">
				<table class="table member_table">
					...
					<tbody>
					<tr>
						<td>모비컴즈_베네피아_리워드배너_AOS_320_100(JSON)</td>
						<td>10886312</td>
					</tr>
					<tr>
						<td>모비컴즈_베네피아_리워드배너_iOS_320_100(JSON)</td>
						<td>10886313 </td>
					</tr>
					<tr>
						<td>모비컴즈_베네피아_사다리배너_AOS_300_250(JSON)</td>
						<td>10886314</td>
					</tr>
					<tr>
						<td>모비컴즈_베네피아_사다리배너_iOS_300_250(JSON)</td>
						<td>10886315</td>
					</tr>
					<tr>
						<td>쿠팡_리워드_배너_AOS</td>
						<td>benepiapointaos</td>
					</tr>
					<tr>
						<td>쿠팡_리워드_배너_iOS</td>
						<td>benepiapointios</td>
					</tr>
					<tr>
						<td>쿠팡_사다리배너_AOS</td>
						<td>benepiasadariaos</td>
					</tr>
					<tr>
						<td>쿠팡_사다리배너_iOS</td>
						<td>benepiasadariios</td>
					</tr>
					</tbody>
				</table>
							...
							<div class="form-group">
								<div class="col-sm-9">
									<span style="float:left;width:120px;height:120px;display: inline-block;line-height: 120px;">
										<img src="<?=$result['img']?>?<?=time()?>" border="1" onerror="this.onerror=null;this.src='http://benepia-admin.commsad.com/img/noImg.jpg'">
									</span>
