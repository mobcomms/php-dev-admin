...
$sql="
	...
	,SUM(IFNULL(OUP.spot_point_cnt5, 0)) + SUM(IFNULL(OUP.spot_point_cnt6, 0)) AS coupang_aos_cnt
	,SUM(IFNULL(OUP.spot_sum_point5, 0)) + SUM(IFNULL(OUP.spot_sum_point6, 0)) AS coupang_aos_sum

	,SUM(IFNULL(OUP.spot_point_cnt7, 0)) + SUM(IFNULL(OUP.spot_point_cnt8, 0)) AS coupang_ios_cnt
	,SUM(IFNULL(OUP.spot_sum_point7, 0)) + SUM(IFNULL(OUP.spot_sum_point8, 0)) AS coupang_ios_sum
				...
				<div class="table-responsive table-wrap">
					<table class="table table-hover mb30" style="border:1px solid #b0b0b0;" id="jb-table">
						...
						<tr>
							...
							<th colspan="2" class="show_aos">일반광고(AOS)</th>
							<th colspan="2" class="show_ios">일반광고(IOS)</th>
							<th colspan="2" class="show_aos">쿠팡광고(AOS)</th>
							<th colspan="2" class="show_ios">쿠팡광고(IOS)</th>
							<th colspan="2" >오퍼월</th>
						</tr>
						<tr>
