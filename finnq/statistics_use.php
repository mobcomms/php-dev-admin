...
$sql .= "
	...
	,IFNULL(CSTATS1.cancel_commission, 0) + IFNULL(CSTATS2.cancel_commission, 0) AS coupang_cancel1
...
$sql .= "
	...
	,IFNULL(CSTATS3.order_commission, 0) + IFNULL(CSTATS4.order_commission, 0) AS coupang_order2
	,IFNULL(CSTATS3.cancel_commission, 0) + IFNULL(CSTATS4.cancel_commission, 0) AS coupang_cancel2
