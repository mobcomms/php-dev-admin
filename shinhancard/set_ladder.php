...
## 환경설정
define('_title_', '사다리 타기 설정');
define('_Menu_', 'setting');
define('_subMenu_', 'ladder_set');
...
<!--					<input type="number" class="form-control pull-left border-input"  style="width:100px; height:35px;" autocomplete="off" name="rejoin_gmae_time" value="--><?//=$result['rejoin_gmae_time']?><!--">-->
				...
				<div class="form-group">
					<div class="col-sm-2" style="line-height:35px;width:200px;">사</div>
					<div class="col-sm-2" style="line-height:35px;width:200px;">다</div>
					<div class="col-sm-2" style="line-height:35px;width:200px;">리</div>
					<div class="col-sm-2" style="line-height:35px;width:200px;">타</div>
					<div class="col-sm-2" style="line-height:35px;width:200px;">기</div>
				</div>
				<div class="form-group">
					<?php for($i=0;$i<5;$i++){ ?>
						<div class="col-sm-2" style="line-height:35px;width:200px;">
							<input type="number" class="form-control pull-left border-input" style="width:85px; height:35px;" autocomplete="off" name="odds_set_point[<?=$i?>]" value="<?=$odds_set_point[$i]?>">
				...
				<div class="form-group">
					<?php for($i=0;$i<5;$i++){ ?>
						<div class="col-sm-2" style="line-height:35px;width:200px;">
							<input type="number" step="0.001" class="form-control pull-left border-input" style="width:85px; height:35px;" autocomplete="off" name="odds_set_percent[<?=$i?>]" value="<?=$odds_set_percent[$i]?>">
